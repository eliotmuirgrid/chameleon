...
1. **Activity & TDEE** — Job (desk vs on feet), steps, **resistance sessions per week**, cardio. Eliot’s **2000 kcal cap** is only a good deficit if it sits **below** real maintenance; Subrina’s **~2200** is a **guess** until activity is known.
...
Turn this draft into a **one-week meal outline** (breakfast / lunch / dinner / snacks) with **two portion columns** or **shared base + add-ons** (e.g., Eliot + extra veg; Subrina + extra carb on training days) once the **information above** is filled in.