...
For the same **compatibility / profile** idea in other domains, see [USB-C charger compatibility](../../../../../../science/physics/electricity/usb-c-power.md) (electrical **profiles**) and [Adaptive communication](../../../communication/adaptive_communication.md) (human **style**), both linked from the [Letter case (for paths and names)](../../letter_case.md) hub as parallel readings.
