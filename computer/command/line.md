...
That typing often happens in a window called **Terminal** (on [macOS](index.md#apple-computers-read-this-if-any-of-this-is-new), Apple’s system software). Help articles sometimes say “paste this line into Terminal”—you do not need to know how it works inside; you run the line and read the result.
