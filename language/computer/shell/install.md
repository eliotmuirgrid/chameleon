...
2. Add team tools to your shell `PATH`:
   - `export PATH="$HOME/chameleon/language/computer/shell:$PATH"`
3. Reload your shell:
   - `source ~/.zshrc`
4. Run commands from any location and maintain the same execution path each cycle.
