...
Use a short hub plus detail pages when helpful: [Concept - Detail Pages](../../organization/detail.md).
...
- Lower [cognitive load](../../cognition/load.md)
- Better [separation of concerns](../../system/design/separation_of_concerns.md)
