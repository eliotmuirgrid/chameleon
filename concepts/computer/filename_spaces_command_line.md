...
**Concept:** On the command line, a **space** usually **splits** one command into **separate words**. Each word is often treated as its **own argument** (its own file name, folder name, or option).
