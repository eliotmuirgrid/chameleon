...
Before a page gets bloated, make sure the hub has:

- Clear title
- One-sentence purpose
- Core tension
- Two or three clear threads
- Links out for black-box terms
- One-line takeaway
...
Stop when another layer adds noise, not clarity.
If a reusable mechanism is still hidden in one adjective, split one more time.

## Glossary packet split

If one file lists many parallel identities, split to:

1. Hub page
2. Matching folder
3. One file per identity
4. Optional folder index
5. Optional redirect stub for old filename

Worked example: [Common filesystems (cross-platform)](../computer/storage/common_filesystems.md).
