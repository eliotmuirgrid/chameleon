...
Keep the main page short. Put longer examples and edge cases in the folder pages. This follows [separation of concerns](../system/design/separation/concerns.md), lowers [cognitive load](../system/design/cognitive_load/load.md), and matches the [concept standard](../rule.md).
