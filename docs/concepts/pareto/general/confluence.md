...
| **Long run** | **Hard** to treat the whole body of work as **portable plain text**; **open** stacks ([Markdown](markdown.md) + [Git](git.md)) usually **age** better for **reuse** and **diffs**. |
...
- [Markdown](markdown.md) · [Git](git.md)  
