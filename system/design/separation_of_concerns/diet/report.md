...
- **Day write-ups (optional):** either **one** `YYYY-MM-DD-summary.md` with **two** sections plus shared detail, or **split files** — `YYYY-MM-DD-summary.md` as a **hub**, `YYYY-MM-DD-summary-eliot.md`, `YYYY-MM-DD-summary-subrina.md`, and `YYYY-MM-DD-shared.md` for batch/split math only ([example](../../../../health/tracking/2026-04-12-summary.md)).
...
- [**Hub**](../../../../health/tracking/2026-04-12-summary.md) — links to the two **person** reports and **shared** cooking reference ([Separation of concerns](../../../../concepts/system/design/separation_of_concerns.md)).
- [**Eliot — report**](../../../../health/tracking/2026-04-12-summary-eliot.md) · [**Subrina — report**](../../../../health/tracking/2026-04-12-summary-subrina.md)
