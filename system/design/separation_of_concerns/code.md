...
That overlap with **small, composable units** is why [Small packet](../small/packet.md) pairs well with this idea.

---

## Cross-reference

- [Diet reports](diet/report.md) — same *pattern*, different domain (shared meals vs individual targets).
